...
public class c_InformationPublisher {
	...
	public int set_objectlist_for_one_room(Integer roomid){
		if(ret){
			...
			/*System.out.println(parser.getSuperParent().Nodes.values());
			System.out.println("childs: "+parser.getAllChildsFrom(parser.getSuperParent()).size());
			System.out.println("child: "+parser.getAllChildsFrom(parser.getSuperParent()).get(0).Nodes.entrySet());*/
